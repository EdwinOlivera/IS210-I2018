...
public class Juego extends Application{
	...
	public void crearObjetosJuego() {
		...
		tile1 = new Tile(0,0,"tilemap",1);
		tile2 = new Tile(64,0,"tilemap",1);
		tile3 = new Tile(128,0,"tilemap",1);
		tile4 = new Tile(192,0,"tilemap",2);
	...
	public void pintar() {
		...
		tile1.pintar(graficos);
		tile2.pintar(graficos);
		tile3.pintar(graficos);
		tile4.pintar(graficos);
		tile5.pintar(graficos);
	}
