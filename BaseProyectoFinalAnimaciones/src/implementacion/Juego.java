...
public class Juego extends Application{
	...
	public void crearObjetosJuego() {	
		...
		jugador = new Jugador(50,250,3, "megaman","descanso");
		fondo1 = new Fondo(0,0,3,"fondo1");
		fondo2 = new Fondo((int)imagenes.get("fondo1").getWidth(),0,5,"fondo2");
		items.add(new Item(300,250,0,"item"));
		items.add(new Item(350,250,0,"item"));
		items.add(new Item(400,250,0,"item"));
		items.add(new Item(450,250,0,"item"));
		items.add(new Item(500,250,0,"item"));
	}
